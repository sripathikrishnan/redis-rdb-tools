...
The rdb file format is optimized for fast read and writes. Where possible LZF compression is used to reduce the file size.
...
This section starts with a one byte flag. A value of @FD@ indicates expiry in seconds. A value of @FC@ indicates expiry in millseconds.
