...
# Thus, our intset looks like - @0x0000FFFC, 0x0000FFFD, 0x0000FFFE@. Notice that the integers were in little endian format i.e. least signinficant bit came first.
