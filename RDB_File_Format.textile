...
----------------------------
FD $length-encoding         # FD indicates "expiry time in seconds". After that, we read the expiry time using length encoding
$value-type                 # 1 byte flag indicating the type of value
$string-encoded-key         # The key, encoded as a redis string
$encoded-value              # The value. Encoding depends on $value-type
----------------------------
FC $length-encoding         # FC indicates "expiry time in ms". After that, we read the expiry time using length encoding
$value-type                 # 1 byte flag indicating the type of value
$string-encoded-key         # The key, encoded as a redis string
$encoded-value              # The value. Encoding depends on $value-type
----------------------------
...
$encoded-value
----------------------------
FE $dbnum-length-encoded    # Next database starts. It also indicates the end of previous database
----------------------------
